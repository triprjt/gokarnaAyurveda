        ...
        <nav className="w-full px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-20">
                    <div className="flex-shrink-0 rounded-full overflow-hidden">
                        <Image onClick={() => window.location.href = '/'} src="/ayurvedaLogo.jpeg" alt="Ayurveda Logo" width={64} height={64} className="object-contain" />
                    </div>
                    ...
                    <button className="md:hidden text-gray-700 hover:text-emerald-700" onClick={() => toggleMenu()}>
                        {!isMenuOpen ? <svg className="w-6 h-6" fill="white" stroke="white" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6h16M4 12h16M4 18h16" />
                        </svg> : <svg className="w-6 h-6" fill="white" stroke="white" viewBox="0 0 24 24">
